...
def main(nelems = [7,10], degree=3, basis_type = 'bspline', interp_degree = 5, preproc = True, multigrid = 1, repair_ordinary = False, local_repair = False, repair_dual = False, problem = 'middle', save = True, ltol = 1e-7, btol = 0.01, name = 'rotor'):
